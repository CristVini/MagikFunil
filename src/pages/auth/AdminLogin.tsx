...
export function AdminLogin() {
  ...
  return (
    <div
      className="min-h-screen bg-stone-950 flex items-center justify-center px-4"
    ...
    >
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-10">
          ...
          <h1
            className="text-2xl font-display font-bold text-stone-50"
            style={{ fontFamily: "var(--font-display)" }}
          >
            MagikFunil Admin
          </h1>
          <p className="text-stone-500 mt-2">
            Área restrita — equipe MagikFunil
          </p>
        </div>
        ...
        <div className="bg-stone-900 border border-stone-800 rounded-2xl p-8">
          <div className="mb-6 flex items-start gap-3 bg-amber-500/10 border border-amber-500/20 rounded-xl p-3">
            ...
            <p className="text-xs text-amber-200">
              Modo demo: qualquer e-mail e senha permitem entrar como
              administrador.
            </p>
          </div>
