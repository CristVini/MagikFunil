                  ...
                  <tr key={plan.id} className="hover:bg-stone-50">
                    ...
                    <td className="px-6 py-4 text-center">
                      <div className="flex flex-col items-center gap-1">
                        {plan.custom_domain && <Shield size={14} className="text-green-500" title="Domínio próprio" />}
                        {plan.multi_user && <Crown size={14} className="text-purple-500" title="Multi-usuário" />}
                        {!plan.brand_free && <Shield size={14} className="text-amber-500" title="Sem 'Powered by'" />}
                      </div>
                    </td>
                    <td className="px-6 py-4 text-center">
